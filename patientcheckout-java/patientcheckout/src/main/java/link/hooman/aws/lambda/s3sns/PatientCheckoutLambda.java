package link.hooman.aws.lambda.s3sns;
...
/*
                // mit LambdaLogger kann Stacktrace in ein Block in CloudWatch geschrieben werden
                StringWriter strWriter = new StringWriter();
                e.printStackTrace(new PrintWriter(strWriter));
                context.getLogger().log(strWriter.toString());
*/
